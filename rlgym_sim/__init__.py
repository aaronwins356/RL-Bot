...
try:
    from rlgym_rocket_league import make
    from rlgym_rocket_league import utils
...
class _EnvsModule:
    """Fake envs module that redirects to rlgym_rocket_league."""
    
    @staticmethod
    def RLGymSimEnv(*args, **kwargs):
        """Legacy RLGymSimEnv - redirects to rlgym_rocket_league.make."""
        warnings.warn(
            "RLGymSimEnv is deprecated. Use rlgym_rocket_league.make() instead.",
            DeprecationWarning,
            stacklevel=2
        )
